...
htmlhtml[data-theme="dark-forest"] body {
    background-image:
...
:roothtml[data-theme="dark-forest"] {
...
htmlhtml[data-theme="dark-forest"] .footer {
...
htmlhtml[data-theme="dark-forest"] body[data-page="home"] .footer {
    background: var(--footer-acrylic-bg) !important;
    backdrop-filter: blur(var(--footer-acrylic-blur)) saturate(var(--footer-acrylic-saturate)) !important;
    -webkit-backdrop-filter: blur(var(--footer-acrylic-blur)) saturate(var(--footer-acrylic-saturate)) !important;
...
htmlhtml[data-theme="dark-forest"] .footer h3,
htmlhtml[data-theme="dark-forest"] .footer h4 {
    color: var(--theme-text-primary);
}

htmlhtml[data-theme="dark-forest"] .footer a {
    color: var(--theme-text-secondary);
    text-decoration: none;
}
